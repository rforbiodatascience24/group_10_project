...
aug_clean_data <- aug_clean_data |> 
  ...
  mutate(
    ...
    Classification_Review = case_when(
      max(`Poor_Review_%`, `Average_Review_%`, `Excellent_Review_%`) == `Poor_Review_%` ~ "Poor",
      max(`Poor_Review_%`, `Average_Review_%`, `Excellent_Review_%`) == `Average_Review_%` ~ "Average",
      max(`Poor_Review_%`, `Average_Review_%`, `Excellent_Review_%`) == `Excellent_Review_%` ~ "Excellent"
    )
  )  |> 
  ungroup() |>  
