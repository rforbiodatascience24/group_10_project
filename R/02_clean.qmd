...
The three rules for making a data set tidy are not satisfied. Each variable must have its own column, each observation have its own row and each value have its own cell.

It can be observed in the data the there are multiple values in each cells for many of the variables.
