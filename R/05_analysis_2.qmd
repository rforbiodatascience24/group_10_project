...
The subset shows the 10 most prevalent drugs in the cancer data. From the dimension of the dataframe, 10 disitnct ID's appear
...
The density plot shows a general trend between Injection and a high number of side effects, hence confirming what is found in the subset of the prevalent drugs. Furthermore, a peak in the density of side effects at \~10 is observed for tablets, which is in accordance with tablet-administrated drugs Advancan and Rolimus in the prevalence medicine subset.
