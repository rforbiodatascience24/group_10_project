...
A subset of the cancer data is made to investigate only the 7 most prevalent types of medicine. These medicines were identified through the descriptive statistics and appear to be the only ones exceeding 1.5% prevalence in the cancer data set.
...
The data frame shows 7 unique ID's, which can also found in the descriptive analysis. There is a majority of average reviews for the 7 most prevalent drugs. Whereas only one appears with an excellent review. Two reviews of the category poor are observed as well. This indicates that an excellent reviews does not seem to affect the prescription and/or choice of a drug, however poor might. Furthermore, that an average classification seems to be enough for a relative high distirbution. It should be noted that nothing conclusive can be said, merely indicative observations which can be used for further analysis.
