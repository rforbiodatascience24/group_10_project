...
This analysis aims to investigate whether the distribution of review classification has a relation to manufacturer or API. The top six of each variable are chosen to enable a meaningful and interpretative visualization.
...
An interesting relation to investigate is the manufacturer's influence on review classification. The top six manufacturers are those with the most products in the data set. The distribution of review classifications of the products that each manufacturer produces is shown in a bar plot.
...
Manufacturers_bar_plot <- cancer_data_selected |> 
  ggplot(aes(x = Classification_Review, 
    ...
    labs(x = '',
         ...
         title = str_wrap("Distribution of Review Classification of Product from Top Six  Manufacturers", 55),
...
-   connect de to plots: er der mon en indreicte correlation mellem API and manufatures?? Amalie må gerne skabe den røde tråd her.
