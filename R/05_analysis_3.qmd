...
Most_prevalent_medicines |>
  ...
  distinct(Medicine_Name, .keep_all = TRUE) |>
  ...
  scale_fill_manual(values =c('#414487FF','#DE9ED6FF'))+
  labs(x = "Drug name",
...
cancer_data |>
  ...
  scale_fill_manual(values =c('#20A387FF', '#95D840FF','#A1D99B','#414487FF', '#E6550D', '#FDE725FF', '#D6616B','#DE9ED6FF' ,'#440154FF' ))  +
  theme_minimal() +
...
Most_prevalent_medicines |>
  ...
  distinct(ID, Medicine_Name, Classification_Review, Administration_type) |>
