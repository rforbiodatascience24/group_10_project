...
It would be plausible to think that drugs with many side effects would be assiociated with a high percentage of poor reviews. This is investigated by looking into the number of side effects and their associated review percentage. Firstly, the environment is cleaned, and libraries and the cancer data is loaded.
...
From this plot no tendency is seen of drugs with fewer side effects having a better review classification or vice versa. The correlation seems completelt random.
...
Average_review_distinct_data <- left_join(Average_review_distinct_data,
                                          count_data,
                                          by = "Administration_type")
...
excellent_review_distinct_data <- left_join(excellent_review_distinct_data,
                                            count_data,
                                            by = "Administration_type")
